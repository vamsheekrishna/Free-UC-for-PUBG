package com.example.myapplication.custom_views.spinningwheel;
...
public class SpinningWheelView extends View implements WheelRotation.RotationListener {
    ...
    private com.example.myapplication.custom_views.spinningwheel.Circle circle;
    ...
    private void initCircle() {
        ...
        circle = new com.example.myapplication.custom_views.spinningwheel.Circle(width, height);
    }
